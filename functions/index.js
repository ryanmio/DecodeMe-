...
exports.getCodeSnippet = functions.https.onRequest(async (request, response) => {
  ...
  const data = {
    ...
    messages: [
      ...
      { role: 'user', content: `Lets play a game that also teaches me python scripts. You will write a short python script in a code block and give me two multiple choice options for what the code does. If I get it right, continue with a slightly harder script. If I get it wrong, continue with a similar script. Dont stop until I say so.` }
    ]
  };
