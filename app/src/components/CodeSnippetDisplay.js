      ...
      <div className="max-w-[600px] mx-auto">
        {loading ? (
          <animated.div style={fadeLoading}>
            <CodeBlock text={"Loading..." + "\n".repeat(5)} language={"plaintext"} showLineNumbers={false} theme={dracula} wrapLines />
          </animated.div>
        ) : (
          <CodeBlock text={formattedCodeSnippet} language={"python"} showLineNumbers={true} theme={dracula} wrapLines />
        )}
      </div>
    </div>
  );
