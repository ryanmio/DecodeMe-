...
const GameHistory = ({ gameHistory, enableReview, onChatWithTutor, onPlaySimilar }) => { 
  return (
              ...
              return (
                <div key={entry.id} className="game-history-entry bg-gray-50 rounded-lg shadow mb-6 p-2">
                  ...
                  <div className="game-answer text-gray-800 p-2">
                    ...
                    {enableReview && <ReviewMenu selectedScript={entry} onChatWithTutor={onChatWithTutor} onPlaySimilar={onPlaySimilar} />} {/* Conditionally render ReviewMenu */}
                  </div>
                </div>
              );
            })}
